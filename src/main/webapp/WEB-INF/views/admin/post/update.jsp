...
<body>
	...
	<form action="updateForm" method="POST">
		...
		<div class="mb-2 row align-items-center">
			...
			<div class="col-auto">
				<input class="form-control shadow-sm" id="title" name="title" value="${postData.title }" maxlength="20" required> 
			</div>
			
			<div class=" col-auto form-check form-check-reverse">
				<label  class="form-check-label"  for="notice">공지사항</label>
				<input class="form-check-input shadow-sm" type="checkbox" id="notice" name="notice" value="1" <c:if test="${postData.notice ==1}" >checked</c:if > >
			</div>
		</div>
		...
		<div class="mb-2">
			<label class="form-label" for="content">내용</label>
				...
				<textarea class="form-control shadow-sm" id="content" rows="5" name="content">${postData.content }</textarea>
			
		</div>

		<div class="d-grid d-block gap-2">
			<input class="btn btn-dark shadow-sm" id="submitButton" type="submit" value="수정">
